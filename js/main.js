(function () {
    var a = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {}
        ...
        , c = function () {
            for (var d, c = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "), "webkitRequestFullScreen webkitCancelFullScreen webkitCurrentFullScreenElement webkitCancelFullScreen webkitfullscreenchange webkitfullscreenerror".split(" "), "mozRequestFullScreen mozCancelFullScreen mozFullScreenElement mozFullScreenEnabled mozfullscreenchange mozfullscreenerror".split(" "), "msRequestFullscreen msExitFullscreen msFullscreenElement msFullscreenEnabled MSFullscreenChange MSFullscreenError".split(" ")], b = 0, e = c.length, g = {}; b < e; b++)
                if ((d = c[b]) && d[1] in a) {
...
function sizeHandler() {
    ...
    if ($("#canvas")) {
        ...
        s_bIsIphone ? (canvas = document.getElementById("canvas"),
            ...
            s_iScaleFactor = 2 * a,
            s_oStage.scaleX = s_oStage.scaleY = 2 * a) : s_bMobile && !1 === isIOS() ? ($("#canvas").css("width", c + "px"),
                $("#canvas").css("height", d + "px")) : (s_oStage.canvas.width = c,
...
function fullscreenHandler() {
    ENABLE_FULLSCREEN && !1 !== screenfull.enabled && (s_bFullscreen = screen.height < window.innerHeight + 3 && screen.height > window.innerHeight - 3 ? !0 : !1,
...
var ENABLE_FULLSCREEN, ENABLE_CHECK_ORIENTATION, TEXT_GAMEOVER = "GAME OVER", TEXT_CONGRATS = "CONGRATULATIONS", TEXT_SCORE = "SCORE", TEXT_BONUS_TIME = "BONUS TIME", TEXT_SELECT_LEVEL = "SELECT A LEVEL", TEXT_SHUFFLE = "SHUFFLE", TEXT_RESTART = "RESTART", TEXT_HINT = "HINT", TEXT_ALERT_EXIT = "DO YOU REALLY WANT TO EXIT?", TEXT_ALERT_RESTART = "DO YOU REALLY WANT TO RESTART?", TEXT_ALERT_SHUFFLE = "DO YOU REALLY WANT TO SHUFFLE?", TEXT_FINAL_SCORE = "FINAL SCORE", TEXT_BEST_SCORE = "BEST SCORE", TEXT_NO_TILES = "NO MORE TILES SELECTABLE!", TEXT_NO = "NO", TEXT_YES = "YES", TEXT_EXIT = "EXIT", TEXT_ERR_LS = "YOUR WEB BROWSER DOES NOT SUPPORT STORING SETTING LOCALLY. IN SAFARI, THE MOST COMMON CAUSE OF THIS IS USING 'PRIVATE BROWSING MODE'. SOME INFO MAY NOT SAVE OR SOME FEATURE MAY NOT WORK PROPERLY.", TEXT_CREDITS_DEVELOPED = "DEVELOPED BY", TEXT_SHARE_IMAGE = "200x200.jpg", TEXT_SHARE_TITLE = "Congratulations!", TEXT_SHARE_MSG1 = "You collected <strong>", TEXT_SHARE_MSG2 = " points</strong>!<br><br>Share your score with your friends!", TEXT_SHARE_SHARE1 = "My score is ", TEXT_SHARE_SHARE2 = " points! Can you do better";
function CPreloader() {
    var a, b, d, c, g, e, f;
    this._init = function () {
...
function CMenu() {
    ...
    this.resetFullscreenBut = function () {
        n && screenfull.enabled && x.setActive(s_bFullscreen)
    }
        ;
...
function CLevelMenu() {
    ...
    this._init = function () {
        ...
        s_oStage.addChild(u);
        var v = createBitmap(s_oSpriteLibrary.getSprite("bg_menu_level"));
        u.addChild(v);
        ...
        x = [];
        v = Math.floor((CANVAS_WIDTH - 2 * EDGEBOARD_X - 100) / NUM_COLS_PAGE_LEVEL) / 2;
    ...
    this._onAudioToggle = function () {
        ...
        ;
    this.resetFullscreenBut = function () {
        B && screenfull.enabled && z.setActive(s_bFullscreen)
    }
        ;
    this._onFullscreenRelease = function () {
